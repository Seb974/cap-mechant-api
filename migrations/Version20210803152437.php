 ...
 */
final class Version20210803152437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD code VARCHAR(20) DEFAULT NULL');
        $this->addSql('ALTER TABLE supplier ADD vif_code VARCHAR(10) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE supplier DROP vif_code');
    }
}
