 ...
 */
final class Version20210810060244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('CREATE TABLE order_entity (id INT AUTO_INCREMENT NOT NULL, metas_id INT DEFAULT NULL, user_id INT DEFAULT NULL, catalog_id INT DEFAULT NULL, promotion_id INT DEFAULT NULL, applied_condition_id INT DEFAULT NULL, touring_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, email VARCHAR(120) DEFAULT NULL, delivery_date DATETIME DEFAULT NULL, status VARCHAR(50) DEFAULT NULL, is_remains TINYINT(1) DEFAULT NULL, total_ht DOUBLE PRECISION DEFAULT NULL, total_ttc DOUBLE PRECISION DEFAULT NULL, message LONGTEXT DEFAULT NULL, payment_id VARCHAR(255) DEFAULT NULL, uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', delivery_priority INT DEFAULT NULL, regulated TINYINT(1) DEFAULT NULL, track_ids LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', reservation_number VARCHAR(50) DEFAULT NULL, invoiced TINYINT(1) DEFAULT NULL, INDEX IDX_CDA754BD23290B3B (metas_id), INDEX IDX_CDA754BDA76ED395 (user_id), INDEX IDX_CDA754BDCC3C66FC (catalog_id), INDEX IDX_CDA754BD139DF194 (promotion_id), INDEX IDX_CDA754BDCF479569 (applied_condition_id), INDEX IDX_CDA754BD36BD1931 (touring_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        // $this->addSql('CREATE TABLE provision (id INT AUTO_INCREMENT NOT NULL, supplier_id INT DEFAULT NULL, seller_id INT DEFAULT NULL, metas_id INT DEFAULT NULL, provision_date DATETIME DEFAULT NULL, status VARCHAR(120) DEFAULT NULL, integrated TINYINT(1) DEFAULT NULL, sending_mode VARCHAR(20) DEFAULT NULL, INDEX IDX_BA9B42902ADD6D8C (supplier_id), INDEX IDX_BA9B42908DE820D9 (seller_id), INDEX IDX_BA9B429023290B3B (metas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        // $this->addSql('CREATE TABLE supplier (id INT AUTO_INCREMENT NOT NULL, seller_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(15) DEFAULT NULL, accounting_id INT DEFAULT NULL, accounting_company_id INT DEFAULT NULL, is_intern TINYINT(1) DEFAULT NULL, vif_code VARCHAR(10) DEFAULT NULL, INDEX IDX_9B2A6C7E8DE820D9 (seller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
