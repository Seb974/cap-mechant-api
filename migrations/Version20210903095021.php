 ...
 */
final class Version20210903095021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(60) DEFAULT NULL, code VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE good (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, provision_id INT DEFAULT NULL, quantity DOUBLE PRECISION DEFAULT NULL, unit VARCHAR(12) DEFAULT NULL, received DOUBLE PRECISION DEFAULT NULL, stock DOUBLE PRECISION DEFAULT NULL, INDEX IDX_6C844E924584665A (product_id), INDEX IDX_6C844E923EC01A31 (provision_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, order_entity_id INT DEFAULT NULL, ordered_qty DOUBLE PRECISION DEFAULT NULL, is_prepared TINYINT(1) DEFAULT NULL, unit VARCHAR(10) DEFAULT NULL, stock DOUBLE PRECISION DEFAULT NULL, INDEX IDX_1F1B251E4584665A (product_id), INDEX IDX_1F1B251E3DA206A5 (order_entity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE order_entity (id INT AUTO_INCREMENT NOT NULL, metas_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, delivery_date DATETIME DEFAULT NULL, status VARCHAR(50) DEFAULT NULL, emails LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_CDA754BD23290B3B (metas_id), INDEX IDX_CDA754BDA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, seller_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, sku VARCHAR(20) DEFAULT NULL, sale_count INT DEFAULT NULL, available TINYINT(1) DEFAULT NULL, unit VARCHAR(12) DEFAULT NULL, weight DOUBLE PRECISION DEFAULT NULL, updated_at DATETIME DEFAULT NULL, is_intern TINYINT(1) DEFAULT NULL, INDEX IDX_D34A04AD8DE820D9 (seller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE provision (id INT AUTO_INCREMENT NOT NULL, supplier_id INT DEFAULT NULL, seller_id INT DEFAULT NULL, metas_id INT DEFAULT NULL, user_id INT DEFAULT NULL, provision_date DATETIME DEFAULT NULL, status VARCHAR(120) DEFAULT NULL, integrated TINYINT(1) DEFAULT NULL, sending_mode VARCHAR(20) DEFAULT NULL, INDEX IDX_BA9B42902ADD6D8C (supplier_id), INDEX IDX_BA9B42908DE820D9 (seller_id), INDEX IDX_BA9B429023290B3B (metas_id), INDEX IDX_BA9B4290A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE supplier (id INT AUTO_INCREMENT NOT NULL, seller_id INT DEFAULT NULL, name VARCHAR(120) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, accounting_id INT DEFAULT NULL, accounting_company_id INT DEFAULT NULL, is_intern TINYINT(1) DEFAULT NULL, vif_code VARCHAR(10) DEFAULT NULL, emails LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_9B2A6C7E8DE820D9 (seller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
